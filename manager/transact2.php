     ...
     ';     require('nav1.php') ;  ;echo '     
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          ...
          <div><ul> '; $query=mysql_query("select * FROM admin ORDER BY sn ASC " )or die(mysql_error());
							while($row=mysql_fetch_array($query)){							$e=$i++
							
							
							;echo ' <li style="float:right; list-style:none; margin:5px;" > <form method="post" enctype="multipart/form-data"> <input name="name" value="'; echo $row['username']; ;echo '" hidden ><input type="submit" name="signout" value="'; echo $row['username'] ;echo '" '; if($userr==$row['username']){;echo ' class="btn btn-primary"'; }else{;echo 'class="btn btn-default"'; };echo ' ></form></li> '; }  ;echo '      
                            </ul> </div>
                            
                            
         <div class="col-lg-12">
            <h1><small>View Transactions</small></h1>
                  ...
                  <div class="panel-body">
                    <div class="table-responsive">
                      <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                          '; $i = 1; 
							$query=mysql_query("select * FROM transact2 ORDER BY sn DESC LIMIT 0, 200" )or die(mysql_error());
							while($row=mysql_fetch_array($query)){							$e=$i++
							...
							;echo '                           <tr class="odd gradeX">
                              ...
                              <td> <a href="profileinv.php?sn='; echo $row['sn'] ;echo '"><i class="btn btn-warning btn-xs">Invoice</i></a></td>
                                         ...
                                         ';  } ;echo '                                         
                                            ...
                                            <td> </td>
                                          <td><b>
                              ';     $result = mysql_query("SELECT SUM(amount-discount) AS value_sum FROM transact2 "); 
...
echo $sum ;
					  ;echo '                            </b></td> 
                            <td><b>
                              ';     $result = mysql_query("SELECT SUM(cash) AS value_sum FROM transact2 "); 
$rowa = mysql_fetch_assoc($result); 
$sum = $rowa['value_sum'];
...
echo $sum ;
					  ;echo '                            </b></td>
                            <td><b>
                              ';     $result = mysql_query("SELECT SUM(amount-cash-discount) AS value_sum FROM transact2 "); 
$rowa = mysql_fetch_assoc($result); 
$sum = $rowa['value_sum'];
...
echo $sum ;
                ...
                <div class="TabbedPanelsContent"><div class="table-responsive">
                      <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                          ';  $i=1;
							$query=mysql_query("select * FROM transact2 WHERE amount-cash-discount != '0' ORDER BY sn DESC" )or die(mysql_error());
							...
							;echo '                           <tr class="odd gradeX">
                              ...
                              <td> <a href="profileinv.php?sn='; echo $row['sn'] ;echo '"><i class="btn btn-warning btn-xs">Invoice</i></a></td>
                                         ...
                                         ';  } ;echo '                                         
                                            ...
                                            <td> </td>
                                          <td><b>
                              ';     $result = mysql_query("SELECT SUM(amount-discount) AS value_sum FROM transact2 WHERE amount-cash-discount != '0' "); 
$rowa = mysql_fetch_assoc($result); 
$sum = $rowa['value_sum'];
...
echo $sum ;
					  ;echo '                            </b></td> 
                            <td><b>
                              ';     $result = mysql_query("SELECT SUM(cash) AS value_sum FROM transact2 WHERE amount-cash-discount != '0' "); 
$rowa = mysql_fetch_assoc($result); 
$sum = $rowa['value_sum'];
...
echo $sum ;
					  ;echo '                            </b></td>
                            <td><b>
                              ';     $result = mysql_query("SELECT SUM(amount-cash-discount) AS value_sum FROM transact2 WHERE amount-cash-discount != '0' "); 
$rowa = mysql_fetch_assoc($result); 
$sum = $rowa['value_sum'];
...
echo $sum ;
           ...
           <div class="panel-body">
                  ...
                  <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                     ';   $i = 1;
							$query=mysql_query("select * FROM transact2 WHERE today = '$today' ORDER BY sn DESC" )or die(mysql_error());
							while($row=mysql_fetch_array($query)){
							$e = $i++;
							$today = date('ymd');
							;echo '							
                              ...
                              <td> <a href="profileinv.php?sn='; echo $row['sn'] ;echo '"><i class="btn btn-warning btn-xs">Invoice</i></a></td>
                                         ...
                                         ';  } ;echo '                                         
                                            ...
                                            <td> </td>
                                          <td><b>
                              ';     $result = mysql_query("SELECT SUM(amount-discount) AS value_sum FROM transact2 WHERE today = '$today' "); 
$rowa = mysql_fetch_assoc($result); 
$sum = $rowa['value_sum'];
...
echo $sum ;
					  ;echo '                            </b></td>
                            <td><b>
                              ';     $result = mysql_query("SELECT SUM(amount-cash-discount) AS value_sum FROM transact2 WHERE today = '$today' "); 
$rowa = mysql_fetch_assoc($result); 
$sum = $rowa['value_sum'];
