    ...
    <div id="wrapper">
     ...
     ';     require('nav1.php') ;  ;echo '     
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
         <div class="col-lg-12">
            <h1><small>View Transactions for '; echo $ww ;echo 'th Week</small></h1>
                  ...
                  <div class="panel-body">
                    <div class="table-responsive">
                      <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                          '; $i = 1; 
							$query=mysql_query("select * FROM transact2 WHERE ww = '$ww'  ORDER BY sn DESC " )or die(mysql_error());
							...
							;echo '                           <tr class="odd gradeX">
                              ...
                              <td> <a href="profileinv.php?sn='; echo $row['sn'] ;echo '"><i class="btn btn-warning btn-xs">Invoice</i></a></td>
                                         ...
                                         ';  } ;echo '                                         
                                            ...
                                            <td> </td>
                                          <td><b>
                              ';     $result = mysql_query("SELECT SUM(amount-discount) AS value_sum FROM transact2 WHERE ww = '$ww'  "); 
...
echo $sum ;
					  ;echo '                            </b></td> 
                            <td><b>
                              ';     $result = mysql_query("SELECT SUM(cash) AS value_sum FROM transact2 WHERE ww = '$ww'  "); 
$rowa = mysql_fetch_assoc($result); 
$sum = $rowa['value_sum'];
...
echo $sum ;
					  ;echo '                            </b></td>
                            <td><b>
                              ';     $result = mysql_query("SELECT SUM(amount-cash-discount) AS value_sum FROM transact2 WHERE ww = '$ww'  "); 
$rowa = mysql_fetch_assoc($result); 
$sum = $rowa['value_sum'];
...
echo $sum ;
                ...
                <div class="TabbedPanelsContent"><div class="table-responsive">
                      <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                          ';  $i=1;
							$query=mysql_query("select * FROM transact2 WHERE ww = '$ww'  AND amount-cash-discount != '0' ORDER BY sn DESC" )or die(mysql_error());
							...
							;echo '                           <tr class="odd gradeX">
                              ...
                              <td> <a href="profileinv.php?sn='; echo $row['sn'] ;echo '"><i class="btn btn-warning btn-xs">Invoice</i></a></td>
                                         ...
                                         ';  } ;echo '                                         
                                            ...
                                            <td> </td>
                                          <td><b>
                              ';     $result = mysql_query("SELECT SUM(amount-discount) AS value_sum FROM transact2 WHERE ww = '$ww'  AND amount-cash-discount != '0' "); 
$rowa = mysql_fetch_assoc($result); 
$sum = $rowa['value_sum'];
...
echo $sum ;
					  ;echo '                            </b></td> 
                            <td><b>
                              ';     $result = mysql_query("SELECT SUM(cash) AS value_sum FROM transact2 WHERE ww = '$ww'  AND amount-cash-discount != '0' "); 
$rowa = mysql_fetch_assoc($result); 
$sum = $rowa['value_sum'];
...
echo $sum ;
					  ;echo '                            </b></td>
                            <td><b>
                              ';     $result = mysql_query("SELECT SUM(amount-cash-discount) AS value_sum FROM transact2 WHERE ww = '$ww'  AND amount-cash-discount != '0' "); 
$rowa = mysql_fetch_assoc($result); 
$sum = $rowa['value_sum'];
