...
include("includes/connect.inc.php");
	 ...
	 $today = date('ymd');	
	  ...
	  $ww = date('W') ;	
	     ...
	     $sqlx =" SELECT * FROM stockup WHERE xm = '$xm' ORDER by sn ASC LIMIT 1 ";
    ...
    <div id="wrapper">
     ...
     ';     require('nav1.php') ;  ;echo '     
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1><small>Manage Expiry Dates</small></h1>
            
              
            <div id="TabbedPanels1" class="TabbedPanels">
              <ul class="TabbedPanelsTabGroup">
                <li class="TabbedPanelsTab" tabindex="0">Expiry Dashboard</li>
<li class="TabbedPanelsTab" tabindex="0">Expiry by Month</li>
              </ul>
                  ...
                  <table class="table table-striped table-bordered table-hover" id="">
							...
							;echo '							
                                  ...
                                  <tr class="odd gradeX">
                                            ...
                                            <td>'; $y = date(Y);  $sql =" SELECT * FROM stockup WHERE xm = '$e' AND xy = '$y' LIMIT 0, 1000 ";
     ...
     $num = mysql_num_rows($result); if($num>0){ ;echo ' <a href="expiry.php?xm='; echo $e ;;echo '&&xy='; $y = date(Y); echo $y ;;echo '" >'; echo $num ; ;echo '</a> '; } ;echo '</td>
                                             <td>'; $y = date(Y)+1;  $sql =" SELECT * FROM stockup WHERE xm = '$e' AND xy = '$y' LIMIT 0, 1000 ";
     $result = mysql_query($sql) or die (mysql_error());
     ...
     <td>'; $y = date(Y)+2;  $sql =" SELECT * FROM stockup WHERE xm = '$e' AND xy = '$y' LIMIT 0, 1000 ";
     $result = mysql_query($sql) or die (mysql_error());
     ...
     <td>'; $y = date(Y)+3;  $sql =" SELECT * FROM stockup WHERE xm = '$e' AND xy = '$y' LIMIT 0, 1000 ";
     $result = mysql_query($sql) or die (mysql_error());
    ...
    <td>'; $y = date(Y)+4;  $sql =" SELECT * FROM stockup WHERE xm = '$e' AND xy = '$y' LIMIT 0, 1000 ";
     $result = mysql_query($sql) or die (mysql_error());
     ...
     <td>'; $y = date(Y)+5;  $sql =" SELECT * FROM stockup WHERE xm = '$e' AND xy = '$y' LIMIT 0, 1000 ";
     $result = mysql_query($sql) or die (mysql_error());
     ...
     <td>'; $y = date(Y)+6;  $sql =" SELECT * FROM stockup WHERE xm = '$e' AND xy = '$y' LIMIT 0, 1000 ";
     $result = mysql_query($sql) or die (mysql_error());
     ...
     <td>'; $y = date(Y)+7;  $sql =" SELECT * FROM stockup WHERE xm = '$e' AND xy = '$y' LIMIT 0, 1000 ";
     $result = mysql_query($sql) or die (mysql_error());
     ...
     <td>'; $y = date(Y)+8;  $sql =" SELECT * FROM stockup WHERE xm = '$e' AND xy = '$y' LIMIT 0, 1000 ";
     $result = mysql_query($sql) or die (mysql_error());
     ...
     <td>'; $y = date(Y)+9;  $sql =" SELECT * FROM stockup WHERE xm = '$e' AND xy = '$y' LIMIT 0, 1000 ";
     $result = mysql_query($sql) or die (mysql_error());
     $num = mysql_num_rows($result); if($num>0){ ;echo ' <a href="expiry.php?xm='; echo $e ;;echo '&&xy='; $y = date(Y)+9; echo $y ;;echo '" >'; echo $num ; ;echo '</a> '; } ;echo '</td>
...
<div class="TabbedPanelsContent">
 <div class="panel-body">
                  ...
                  <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                     '; 
							$query=mysql_query("select * FROM stockup WHERE xm = '$sm' AND xy = '$sy' ORDER BY sn DESC" )or die(mysql_error());
							...
							;echo '							
                                  ...
                                  <tr class="odd gradeX">
                                            ...
                                            <td>'; echo ucfirst($row['item']) ;echo '</td>
                                             ...
                                             <td>'; echo ucfirst($row['nqty']) ;echo '</td>
                                            <td>'; echo ucfirst($row['sprice']) ;echo '</td>
                                             <td class="center">'; echo $row['nqty']*$row['sprice'] ; ;echo '</td>
