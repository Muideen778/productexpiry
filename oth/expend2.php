    ...
    <div id="wrapper">
     ...
     ';     require('nav1.php') ;  ;echo '     
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1><small>View Expenditure</small></h1>
            
              
            <div id="TabbedPanels1" class="TabbedPanels">
              <ul class="TabbedPanelsTabGroup">
                <li class="TabbedPanelsTab" tabindex="0">All Expenses</li>
                <li class="TabbedPanelsTab" tabindex="0">'; echo date(F)  ;;echo ' Expenses</li>
<li class="TabbedPanelsTab" tabindex="0">'; echo date('l  jS ')  ;;echo ' Expenses</li>
</ul>
                  ...
                  <div class="panel-body">
                    <div class="table-responsive">
                      <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                          '; 
							$query=mysql_query("select * FROM expend ORDER BY sn DESC" )or die(mysql_error());
                          ...
                          ';  } ;echo '                          <tr>
                            <td><b>Total:</b></td>
                            <td><b>
                              ';     $result = mysql_query("SELECT SUM(amount) AS value_sum FROM expend WHERE mm = '$mm' "); 
                  ...
                  <div class="panel-body">
                    <div class="table-responsive">
                      <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                          '; 
							$query=mysql_query("select * FROM expend WHERE mm = '$mm' ORDER BY sn DESC" )or die(mysql_error());
							while($row=mysql_fetch_array($query)){
							$id=$row['id'];
  ...
  <div class="panel-body">
    <div class="table-responsive">
      <table class="table table-striped table-bordered table-hover" id="dataTables-example">
        ...
        <tbody>
          '; 
							$query=mysql_query("select * FROM expend WHERE dd = '$dd' ORDER BY sn DESC" )or die(mysql_error());
							while($row=mysql_fetch_array($query)){
							$id=$row['id'];
          ...
          ';  } ;echo '          <tr>
            <td><b>Total:</b></td>
            <td><b>
              ';     $result = mysql_query("SELECT SUM(amount) AS value_sum FROM expend WHERE dd = '$dd' "); 
$rowa = mysql_fetch_assoc($result); 
$sum = $rowa['value_sum'];
