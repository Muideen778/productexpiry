...
//'<?php $q=mysql_query("select * FROM title LIMIT 1 " );
			$r=mysql_fetch_array($q); echo $r['name']; ;echo '\'
...
$other = $_POST[\'other\'];
	   	     ...
	   	     if(array_key_exists(\'register\', $_POST)){
				  ...
				  $qry = "SELECT * FROM client WHERE name = \'$name\' AND phone = \'$phone\' ";
...
$sql = "INSERT INTO client (name,phone,address,sex,company,other,email,today,rep)
    ...
    <div id="wrapper">
     ...
     ';     require('nav1.php') ;  ;echo '     
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1><small>Manage Customers</small></h1>
            
              
            <div id="TabbedPanels1" class="TabbedPanels">
              <ul class="TabbedPanelsTabGroup">
                <li class="TabbedPanelsTab" tabindex="0">Customer List</li>
<li class="TabbedPanelsTab" tabindex="0">Add Customer</li>
              </ul>
                  ...
                  <table class="table table-striped table-bordered table-hover" id="dataTables-example">
							...
							;echo '							
                                  ...
                                  <tr class="odd gradeX">
                                            ...
                                            <td class="center"><i class="btn btn-warning btn-xs"> <font color="white"><b>';  echo $row['tno'] ;echo '</b></font></i></td>
...
<div class="TabbedPanelsContent">
<div class="fm1"><h3>Customer information</h3>  <font color="#FF0000"> '; echo $reportadded; ;echo ' </font>        
            <p>
...
<button type="submit" class="btn btn-default" name="register">Add Customer</button>
