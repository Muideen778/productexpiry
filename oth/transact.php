      ...
      <div id="page-wrapper">
        ...
        <div class="row">
         <div style="float:right;"><ul> '; $query=mysql_query("select * FROM admin ORDER BY sn ASC LIMIT 0 , 10" )or die(mysql_error());
							...
							;echo ' <li  class="btn btn-default" style="float:left; list-style:none; margin-left:10px; '; if($distributor==$row['username']){ ;echo 'background-color:#CF9; '; } ;echo '"> <a href="transact.php?distributor='; echo $row['username'];;echo '" style="text-decoration:none;">'; echo ucfirst($row['username']) ; ;echo '</a></li> '; }  ;echo '  </ul> </div> <div class="col-lg-12">
