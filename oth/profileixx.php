...
$sql = "INSERT INTO transact (id,name,phone,item,des,cat,qty,price,amount,other,rep,today,dd,mm,yy,ww)
VALUES('$id','$name','$phone','$item2','$des','$item2','$qty','$price','$amount','$other','$rep','$today','$dd','$mm','$yy','$ww')";
$res2 = mysql_query($sql) or die(mysql_error());
...
$url = "http://www.trenetsms.com/components/com_spc/smsapi.php?username=testing&password=testgni&sender=$senderid&recipient=$phone&message=$msg2";
...
echo $sum ;
                ...
                <div class="TabbedPanelsContent">
                  <div class="fm1">
                    ...
                    '; echo $reportadded.'  ' ;;echo ' <font color="#FF0000">'; echo $er; ;echo '</font>
                          ...
                          <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                       ...
                                       <tr>
                                            ...
                                            <td colspan="2">Date: '; echo date(d.'-'.m.'-'.Y); ;echo '<br><br>Time: '; echo date(h.':'.i.':'.s) ; ;echo '</td>
                                      </tr>
...
;echo ' Naira
                            ...
                            <a href="profileinv.php?id='; echo $id3 ; ;echo '"><i class="btn btn-success btn-xs">Print Version</i></a>
