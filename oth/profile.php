...
//header("location:http://www.trenetsms.com/components/com_spc/smsapi.php?username=testing&password=testgni&sender=$senderid&recipient=$phone&message=$msg");
//exit;
...
<button type="submit" class="btn btn-default" name="register">Edit Customer Info</button>
