      ...
      <div id="page-wrapper">
        ...
        <div class="row">
         <div style="float:right;"><ul> '; $query=mysql_query("select * FROM admin ORDER BY sn ASC LIMIT 0 , 10" )or die(mysql_error());
							...
							;echo ' <li  class="btn btn-default" style="float:left; list-style:none; margin-left:10px;"> <a href="transact.php?distributor='; echo $row['username'];;echo '" style="text-decoration:none;">'; echo ucfirst($row['username']) ; ;echo '</a></li> '; }  ;echo '  </ul> </div> <div class="col-lg-12">
 ...
 <td><a href="profilei.php?id='; echo $row['id'] ;echo '"><i class="btn btn-success btn-xs">'; echo ucfirst($row['name']) ;echo '</i></a></td>                            <td>'; echo ucfirst($row['phone']) ;echo '</td>
                ...
                <div class="TabbedPanelsContent"><div class="table-responsive">
                      <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                          '; 
							$query=mysql_query("select * FROM transact WHERE balance != '0' ORDER BY sn DESC" )or die(mysql_error());
